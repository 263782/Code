...
<div class="wrapper">
    ...
    <div class="uitleg"> 
        ...
        <br><p>Wij leiden je op tot een <b>veilig</b> en <b>zelfstandig</b> automobilist. De cursus verloopt volgens een gestructureerde <br>
    ...
    <div class="meerinfo">
            <div class="blok">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M14 17H4v2h20v-2zm6-8H4v2h16V9zM4 15h16v-2H4v2zM4 5v2h16V5H4z"/><path d="M0 0h24v24H0z" fill="none"/></svg>                <form action="http://">
                    <form action="http://26378.hosts2.ma-cloud.nl/code/public/opleiding.php">
            ...
            <div class="blok">
                ...
                <form action="http://26378.hosts2.ma-cloud.nl/code/public/auto.php">
                    <input class="uitleg__button" type="submit" value="MEER INFORMATIE"/>
                </form> 
            </div>
            ...
            <div class="blok">
                ...
                <form action="http://26378.hosts2.ma-cloud.nl/code/public/tarieven.php">
                    <input class="uitleg__button" type="submit" value="MEER INFORMATIE"/>
                </form> 
            </div>
    </div>
